...
begin
  ...
  if not exists (select 1 from public.properties where title like '%Demo%') then
    ...
    (v_ind, 'Clean 2 Bedroom Flat, Surulere (Demo)',
     ...
     2, 2, 85, array['https://qjlwmpbmrdercymcnroz.supabase.co/storage/v1/object/public/property-media/pm-flat1.jpg','https://qjlwmpbmrdercymcnroz.supabase.co/storage/v1/object/public/property-media/pm-flat2.jpg'],
    ...
    (v_ind, 'Half Plot of Family Land, Ikorodu (Demo)',
     ...
     null, null, 300, array['https://qjlwmpbmrdercymcnroz.supabase.co/storage/v1/object/public/property-media/pm-land1.jpg'],
    ...
    (v_agt, 'Five Bedroom Detached Duplex with BQ, Lekki Phase 1 (Demo)',
     ...
     5, 5, 620, array['https://qjlwmpbmrdercymcnroz.supabase.co/storage/v1/object/public/property-media/pm-duplex1.jpg','https://qjlwmpbmrdercymcnroz.supabase.co/storage/v1/object/public/property-media/pm-duplex2.jpg','https://qjlwmpbmrdercymcnroz.supabase.co/storage/v1/object/public/property-media/pm-duplex3.jpg'],
     '{}', array['https://qjlwmpbmrdercymcnroz.supabase.co/storage/v1/object/public/property-media/demo_360_interior.jpg'],
    ...
    (v_agt, 'Serviced 3 Bedroom Apartment, Wuse 2 (Demo)',
     ...
     3, 3, 140, array['https://qjlwmpbmrdercymcnroz.supabase.co/storage/v1/object/public/property-media/pm-wuse1.jpg','https://qjlwmpbmrdercymcnroz.supabase.co/storage/v1/object/public/property-media/pm-wuse2.jpg'],
    ...
    (v_agt, 'Open Plan Office Space, GRA Port Harcourt (Demo)',
     ...
     null, 2, 450, array['https://qjlwmpbmrdercymcnroz.supabase.co/storage/v1/object/public/property-media/pm-office1.jpg'],
    ...
    (v_dev, 'Crestline Court: 4 Bedroom Terraces, Sangotedo (Demo)',
     ...
     4, 4, 280, array['https://qjlwmpbmrdercymcnroz.supabase.co/storage/v1/object/public/property-media/pm-estate1.jpg','https://qjlwmpbmrdercymcnroz.supabase.co/storage/v1/object/public/property-media/pm-estate2.jpg'],
    ...
    (v_dev, 'Serviced Residential Plots, Kuje Scheme (Demo)',
     ...
     null, null, 600, array['https://qjlwmpbmrdercymcnroz.supabase.co/storage/v1/object/public/property-media/pm-plots1.jpg'],
     '{}', array['https://qjlwmpbmrdercymcnroz.supabase.co/storage/v1/object/public/property-media/demo_360_plot.jpg'],
    ...
    (v_dev, 'Ibadan Mixed Use Development, Bodija (Demo)',
     ...
     null, null, 1200, array['https://qjlwmpbmrdercymcnroz.supabase.co/storage/v1/object/public/property-media/pm-mixed1.jpg'],
