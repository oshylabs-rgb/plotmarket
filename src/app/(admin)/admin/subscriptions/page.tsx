...
export default function AdminSubscriptionsPage() {
  ...
  const getUser = (id: string) => profiles.find((p) => p.id === id)
    ...
    <div>
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-3">
        <div className="rounded-xl border border-brand-cream-300 bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-2xl font-bold text-gray-900">{activeSubs.length}</p>
        </div>
        <div className="rounded-xl border border-brand-cream-300 bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-2xl font-bold text-gray-900">{expiredSubs.length}</p>
        </div>
        <div className="rounded-xl border border-brand-cream-300 bg-white p-5 shadow-sm">
